...
func SelectUser(ctx context.Context, conn db.Conn, queries Queries, id int) (User, bool, error) {
	return db.GetDialect[User](ctx, conn, queries.GetUser, id)
}

func SelectUserExp(ctx context.Context, conn db.Conn, id int) (User, bool, error) {
